    ...
    <>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: "فعاليات نشطة", value: "٢", color: "#3D3A5C", icon: "🎉" },
            { label: "إجمالي المجموعات", value: "١٠", color: "#C46878", icon: "👥" },
            { label: "تم جمعه", value: "١٣٬٦٥٠ ر.س", color: "#3D3A5C", icon: "💰" },
            { label: "تقييمي", value: "٤.٩ ⭐", color: "#C46878", icon: "🏆" },
          ].map((s) => (
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/user/events" className="text-sm text-[#C46878] font-semibold">
              عرض الكل
            </Link>
          </div>
            ...
            {MOCK_EVENTS.map((ev) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="font-bold text-base" style={{ color: "#3D3A5C" }}>{ev.title}</h3>
                ...
                <div className="mb-3">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${ev.progress}%`, background: "linear-gradient(90deg, #3D3A5C, #3D3A5C)" }}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm font-bold" style={{ color: "#3D3A5C" }}>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { icon: "🎉", label: "فعالية جديدة", href: "/user/events/new", color: "#3D3A5C" },
              { icon: "🔗", label: "دعوة أصدقاء", href: "#", color: "#C46878" },
              { icon: "🏪", label: "تصفح الموردين", href: "#", color: "#3D3A5C" },
              { icon: "💰", label: "إدارة القطّة", href: "#", color: "#C46878" },
            ].map((action) => (
              <Link
                key={action.label}
                href={action.href}
